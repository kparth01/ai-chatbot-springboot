...
public class ArticleRepository {
    ...
    @Autowired
    public ArticleRepository(@Value("${app.load-articles}") Boolean shouldLoadArticles,
    ...
    public ArticleRepository(EmbeddingStore<TextSegment> embeddingStore,
    ...
    private void loadArticles() throws IOException {
        ...
        List<TextSegment> documents =
            loadJsonDocuments(resourcePath, maxTokensPerChunk, overlapTokens);
    ...
    private List<TextSegment> loadJsonDocuments(String resourcePath, int maxTokensPerChunk,
                                                int overlapTokens) throws IOException {

        InputStream inputStream =
            ArticleRepository.class.getClassLoader().getResourceAsStream(resourcePath);
    ...
    private void addDocumentToBatch(String title, String body, JsonNode metadataNode,
                                    List<Document> batch) {
    ...
    private List<TextSegment> splitIntoChunks(List<Document> documents, int maxTokensPerChunk,
                                              int overlapTokens) {
